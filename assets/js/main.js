...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!mapDiv || !lookupBtn) return; // 如果不在首頁就跳過
    ...
    lookupBtn.addEventListener('click', async function() {
        ...
        try {
            ...
            if (!data.length) throw new Error('找不到地址');
            ...
            zoningDisplay.innerText = '查詢失敗，請確認地址或稍後再試。';
            console.error(error);
        }
    });
});
